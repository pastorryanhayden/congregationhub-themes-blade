                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        @if(!empty($s['youtubeId']))
                            <div class="relative w-full aspect-video bg-black rounded-2xl overflow-hidden shadow-xl">
                                <iframe
                        ...
                        @elseif(!empty($seriesData['image']))
                            <div class="relative w-full aspect-[21/9] rounded-2xl overflow-hidden shadow-xl">
                        ...
                        {{-- Title & Meta --}}
                        <div>
                            <h1 class="text-3xl lg:text-4xl font-serif font-bold text-base-content mb-3">{{ $title }}</h1>
                        ...
                        <div class="flex flex-wrap gap-3">
                            @if(!empty($s['mp3Url']))
                                <a href="{{ $s['mp3Url'] }}" class="btn btn-primary rounded-full" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M5.25 5.653c0-.856.917-1.398 1.667-.986l11.54 6.347a1.125 1.125 0 0 1 0 1.972l-11.54 6.347a1.125 1.125 0 0 1-1.667-.986V5.653Z" />
                                    </svg>
                                    Play Audio
                                </a>
                                <a href="{{ $s['mp3Url'] }}" download class="btn btn-outline rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                            ...
                            @if(!empty($s['handoutUrl']))
                                <a href="{{ $s['handoutUrl'] }}" download class="btn btn-outline rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                            ...
                            @if(!empty($s['slidesUrl']))
                                <a href="{{ $s['slidesUrl'] }}" download class="btn btn-outline rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
                        ...
                        @if(!empty($s['description']))
                            <div class="bg-base-100 rounded-2xl border-l-4 border-primary p-6">
                    ...
                    <div class="space-y-6">
                        ...
                        {{-- Speaker Card --}}
                        @if($speaker)
                            <a href="/sermons/speakers/{{ $speaker['slug'] }}" class="block bg-base-100 rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow group">
                        ...
                        {{-- Back to Sermons --}}
                        <a href="/sermons" class="btn btn-ghost gap-2 w-full rounded-full">
